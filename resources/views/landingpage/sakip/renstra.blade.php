...
@section('content')
    <section class="dokumen-hero">
        ...
        <div class="dokumen-content">
            ...
            <h1 class="dokumen-title">RENCANA STRATEGIS</h1>
            <p class="dokumen-subtitle">Badan Kesatuan Bangsa dan Politik Kota Bandung</p>
            <p class="dokumen-lead">Dokumen perencanaan jangka menengah yang memuat visi, misi, tujuan, sasaran, strategi, dan arah kebijakan untuk mencapai target pembangunan selama periode lima tahun</p>
        </div>
    </section>
