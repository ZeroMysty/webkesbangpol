...
@section('content')
    <section class="dokumen-hero">
        ...
        <div class="dokumen-content">
            ...
            <h1 class="dokumen-title">PENGUKURAN KERJA</h1>
            <p class="dokumen-subtitle">Badan Kesatuan Bangsa dan Politik Kota Bandung</p>
            <p class="dokumen-lead">Dokumen Evaluasi Yang Berisi Capaian Pelaksanaan Program Dan Kegiatan, Digunakan Untuk Menilai Efektivitas Kinerja Dalam Mencapai Tujuan Dan Sasaran Pembangunan</p>
