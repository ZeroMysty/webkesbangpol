...
@section('content')
    <section class="dokumen-hero">
        ...
        <div class="dokumen-content">
            ...
            <h1 class="dokumen-title">RENCANA KERJA</h1>
            <p class="dokumen-subtitle">Badan Kesatuan Bangsa dan Politik Kota Bandung</p>
            <p class="dokumen-lead">Dokumen perencanaan tahunan yang memuat program dan kegiatan yang diperlukan untuk mencapai sasaran pembangunan</p>
        </div>
    </section>
