...
@section('content')
    <section class="dokumen-hero">
        ...
        <div class="dokumen-content">
            ...
            <h1 class="dokumen-title">INDIKATOR KINERJA UTAMA</h1>
            <p class="dokumen-subtitle">Badan Kesatuan Bangsa dan Politik Kota Bandung</p>
            <p class="dokumen-lead">Dokumen yang memuat ukuran kinerja utama sebagai acuan dalam mengukur keberhasilan pencapaian tujuan dan sasaran strategis instansi</p>
        </div>
    </section>
